...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String DDL_CREATE_BOOK_TABLE =
        ...
        final String DDL_CREATE_AUTHOR_TABLE =
                "CREATE TABLE " + AlexandriaContract.AuthorEntry.TABLE_NAME + " ("+
        ...
        final String DDL_CREATE_CATEGORY_TABLE =
                "CREATE TABLE " + AlexandriaContract.CategoryEntry.TABLE_NAME + " ("+
        ...
        Log.d(LOG_TAG, "ddl-statments_book: " + DDL_CREATE_BOOK_TABLE);
        Log.d(LOG_TAG, "ddl-statments_autor: " + DDL_CREATE_AUTHOR_TABLE);
        Log.d(LOG_TAG, "ddl-statments_category: " + DDL_CREATE_CATEGORY_TABLE);

        db.execSQL(DDL_CREATE_BOOK_TABLE);
        db.execSQL(DDL_CREATE_AUTHOR_TABLE);
        db.execSQL(DDL_CREATE_CATEGORY_TABLE);
    }
